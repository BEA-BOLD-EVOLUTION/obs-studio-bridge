...
export function createCreatorMcpServer({ accessToken, listDevices, dispatchCommand }) {
  ...
  server.registerTool("obs_inspect_status", {
    ...
    annotations: readOnly
  }, async ({ deviceId }) => result(await dispatchCommand(accessToken, deviceId, {
    tool: "obs_inspect_status",
    arguments: {}
  })));
  ...
  }, async ({ deviceId, sceneName }) => result(await dispatchCommand(accessToken, deviceId, {
  ...
  server.registerTool("obs_run_ai_transition", {
    ...
    annotations: write
  }, async ({ deviceId, ...args }) => result(await dispatchCommand(accessToken, deviceId, {
    tool: "obs_run_ai_transition",
    arguments: args
  })));
